...
int main()
{
    ...
    Shader lightingShader("../Resource/shader/LightingDemo/light_casters.vs", "../Resource/shader/LightingDemo/light_casters.frag");
    ...
    unsigned char* image;
    // Diffuse map
    image = SOIL_load_image("../Resource/shader/LightingDemo/container2.png", &width, &height, 0, SOIL_LOAD_RGB);
    ...
    // Specular map
    image = SOIL_load_image("../Resource/shader/LightingDemo/container2_specular.png", &width, &height, 0, SOIL_LOAD_RGB);
