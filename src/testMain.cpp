...
int main()
{
    ...
    Shader shader("../Resource/shader/framebuffer/framebuffers.vert", "../Resource/shader/framebuffer/framebuffers.frag");
...
#pragma region "object_initialization"
    ...
    // Load textures
    GLuint cubeTexture = SOIL_load_OGL_texture("../Resource/pic/LightingDemo/container2.png", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS | SOIL_FLAG_NTSC_SAFE_RGB );
    GLuint floorTexture = SOIL_load_OGL_texture("../Resource/pic/negy.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS | SOIL_FLAG_NTSC_SAFE_RGB );
